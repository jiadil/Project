...
<body>
    ...
    $sql = "update Staff set name = '$newName', phoneNum = '$newPhone' where sinNum = $id";
    ...
    ?>
        <div class="alert alert-success text-center" role="alert">
            ...
            <p>Staff Info Updated successfully!
            <hr>
    ...
    ?>
        <div class="alert alert-danger text-center" role="alert">
            ...
            <hr>
            <a href="/strata/staff/staff.php" class="btn btn-primary">Go Back to All Company Owners</a>
        </div>
    <?php
    }
    ?>
